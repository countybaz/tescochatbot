      ...
      {!showingOffer ? (
        <>
          ...
          <div className="mb-4 space-y-3">
            ...
            {/* Blue promotional text (changed from orange to match Tesco branding) */}
          ...
          <div>
            <a 
              href="https://www.tapplink.co/21468/1076/cb" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="block w-full"
            >
              <Button 
                className={`w-full bg-blue-700 hover:bg-blue-800 py-6 text-lg font-bold border-2 border-blue-800 shadow-lg fixed bottom-4 left-0 right-0 max-w-xs mx-auto z-20 md:static md:max-w-md ${isMobile ? 'h-16 text-xl' : ''}`}
              >
