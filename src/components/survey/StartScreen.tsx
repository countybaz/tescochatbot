    ...
    <div className="max-w-md mx-auto pb-20 md:pb-0">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-6">
        ...
        <p className="text-center mb-6">
          Ready to earn rewards for your feedback? Click on the <span className="text-blue-700 font-semibold">Start</span> button below.
        </p>
      ...
      <Button 
        onClick={handleStart} 
        className={`w-full bg-blue-700 hover:bg-blue-800 text-lg py-6 shadow-lg border-2 border-blue-800 font-bold fixed bottom-4 left-0 right-0 max-w-xs mx-auto md:static md:max-w-md z-20 ${isMobile ? 'h-16 text-xl' : ''}`}
      >
