...
const FALLBACK_IMAGE = "/lovable-uploads/58a9571b-a254-431a-94a9-3d4cdec07246.png";
const FacebookReviews = () => {
  ...
  const allReviews: Review[] = [{
    ...
    time: "2 hours ago",
    text: "Just received my £100 Tesco gift card! The survey was super easy and the card arrived quickly. So happy with this program!",
    likes: 24,
    comments: 2
  }, {
    name: "Michael Thomas",
  ...
  // Adding text-only reviews 
  {
    ...
    time: "4 days ago",
    text: "Thought it was too good to be true, but I'm literally using my £100 Tesco gift card today! Perfect timing as I needed to stock up on groceries.",
    likes: 21,
    comments: 3
  }, {
    name: "Liam Johnson",
    ...
    time: "Last week",
    text: "Just got my Tesco gift card yesterday. Already used £20 of it for my shopping today. Such a helpful boost to the monthly budget!",
    likes: 15,
    comments: 1
  }, {
    name: "Ava Thompson",
  ...
  return (
    <div className="mt-8 bg-white rounded-lg shadow-md p-4">
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        <button onClick={refreshComments} className="text-sm text-blue-700 hover:underline">
      ...
      {displayedReviews.map((review, index) => (
        <div className="mb-4" key={index}>
          ...
          {/* Tesco's Review Program Replies - only show for randomly selected reviews */}
              ...
              <div className="flex items-start">
                ...
                <div>
                  <div className="flex items-center gap-1">
                    <h5 className="text-xs font-semibold text-[#3b5998]">Tesco Review Program</h5>
      ...
      <div className="text-center mt-2">
        <button className="text-blue-700 text-sm font-semibold" onClick={() => setShowAllReviews(!showAllReviews)}>
